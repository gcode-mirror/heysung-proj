...
extern int     UseReEntry     =  1;    // Re-Entry Mode: 0-off,1-on
extern int     AlertMode      =  1;    // Alert Mode: 0-off,1-on
extern int     WarningMode    =  1;    // Warning Mode: 0-off,1-on
extern string  WarningSound   =  "alert2.wav"; 
//---- indicator buffers
double UpSignal[];
double DnSignal[]; 
double UpEntry[];
