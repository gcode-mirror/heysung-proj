...
int start()
{
   ...
   */
   if(Trend[1] != TrendDoA[1] && Trend[2] == TrendDoA[2] && Bars > a) {
      ...
      if(SignalMail) SendMail("SuperTrend bar closed Blue","SuperTrend bar closed Blue");
      a=Bars;
   }
   if(Trend[1] == TrendDoA[1] && Trend[2] != TrendDoA[2] && Bars > b) {
      if(SignalAlert) Alert( Symbol() + " SuperTrend bar DOWN");
      if(SignalMail) SendMail("SuperTrend bar closed Red","SuperTrend bar closed Red");
      b=Bars;
   }
